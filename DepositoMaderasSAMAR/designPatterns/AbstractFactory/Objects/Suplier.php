...
class Suplier implements WorkerIntern {
    ...
    //Funciones específicas que van a tener los usuarios proveedores
    //Función asignar nombre de usuario
    function assignUserName( )
    {
        
        $userName = 'Sup'.substr( $this->userName, 0, 5).substr( $this->telephone, 0, 2);
